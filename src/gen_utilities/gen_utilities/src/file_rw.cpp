...
namespace file_rw
{
    std::vector< std::vector<double> > file_read_vec(std::string file_name)
    {
        std::string tok;
    ...
    void file_write(std::string file_name, const std::vector< std::vector<int> >& vec)
    {
    ...
    void file_write(std::string file_name, const std::vector< std::vector<float> >& vec)
    {
        std::ofstream out_file;
        out_file.open(file_name.c_str(),std::ios::out);
        for (long i=0;i<vec.size();++i)
    ...
    void file_write(std::string file_name, const std::vector< std::vector<double> >& vec)
    {
        std::ofstream out_file;
        out_file.open(file_name.c_str(),std::ios::out);
        for (long i=0;i<vec.size();++i)
    ...
    void file_write(std::string file_name, const Eigen::MatrixXi& mat)
    {
        std::ofstream out_file;
        out_file.open(file_name.c_str(),std::ios::out);
        for (long i=0;i<mat.rows();++i)
    ...
    void file_write(std::string file_name, const Eigen::MatrixXf& mat)
    {
        std::ofstream out_file;
        out_file.open(file_name.c_str(),std::ios::out);
        for (long i=0;i<mat.rows();++i)
