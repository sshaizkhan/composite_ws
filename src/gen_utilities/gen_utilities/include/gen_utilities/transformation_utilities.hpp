...
namespace rtf
{
	...
	//! Rotation Matrix [3x3]
	//! Euler Angles [1x3] in radians
	//! Quaternion [1x4]

	//! Make homogenous transformation matrix from translation vector and rotation matrix 
	Eigen::Matrix4i hom_T(Eigen::Vector3i, Eigen::Matrix3i);
	Eigen::Matrix4f hom_T(Eigen::Vector3f, Eigen::Matrix3f);
	...
	Eigen::MatrixXd apply_transformation_to_waypoints(Eigen::MatrixXd, Eigen::Matrix4d);
	Eigen::MatrixXd apply_transformation(Eigen::MatrixXd, Eigen::MatrixXd);
	Eigen::MatrixXd apply_transformation_to_waypoints(Eigen::MatrixXd, Eigen::MatrixXd);
	...
	Eigen::Matrix3d eul2rot(Eigen::MatrixXd, std::string="");
	...
	//! NOTE: Euler Angles are: (alpha,beta,gamma), Default sequence: ZYX 
	//! NOTE: Input Quaternion is in [x,y,z,w] form 
	Eigen::MatrixXd eul2qt(Eigen::MatrixXd, std::string="");
	...
	Eigen::MatrixXd pose_to_hom_T(Eigen::MatrixXd);

	//! convert homogenous tranformation to pose vector 
	Eigen::MatrixXd hom_T_to_pose(Eigen::MatrixXd);
	Eigen::MatrixXd hom_T_to_pose(Eigen::Matrix4d);
};
