...
void idleFunction(void)
{
  ...
  std::cout << "we in AlecZach" << std::endl;
  sheet->resetConstraints();
  if(timeStepCount<460 && timeStepCount>=210){
    // cout <<"push"<<endl;
sheet->MoveSurfaceTo(fix1,0,-0.004*t);
sheet->MoveSurfaceTo(fix2,0,0);
sheet->MoveSurfaceTo(fix3,0,0);
sheet->MoveSurfaceTo(fix4,0,0);
  }
//   else if(timeStepCount<730 && timeStepCount>=480){
//     // cout <<"pull"<<endl;
...
// sheet->MoveSurfaceTo(fix4,0,0);
//   }
//   else if(timeStepCount<1000 && timeStepCount>=750){
// sheet->MoveSurfaceTo(fix1,0,0);
// sheet->MoveSurfaceTo(fix2,0,0);
// sheet->MoveSurfaceTo(fix3,0,0.004*t);
// sheet->MoveSurfaceTo(fix4,0,0);
//   }
//   else if(timeStepCount<1270 && timeStepCount>=1020){
// sheet->MoveSurfaceTo(fix1,0,0);
// sheet->MoveSurfaceTo(fix2,0,0);
// sheet->MoveSurfaceTo(fix3,0,0);
