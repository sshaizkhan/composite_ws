...
void idleFunction(void)
{
  ...
  // if(timeStepCount<20){
  //   // cout <<"push"<<endl;
  //     sheet->MoveSurfaceTo(split_lo,0,-0.002*t);
  //     sheet->MoveSurfaceTo(split_hi,1,0.004*t);
  // }
  // else if(timeStepCount<50 && timeStepCount>=30){
  //   // cout <<"pull"<<endl;
  //     sheet->MoveSurfaceTo(split_lo,0,0.002*t);
  //     sheet->MoveSurfaceTo(split_hi,1,-0.004*t);
  // }
  // else if(timeStepCount<80 && timeStepCount>=60){
  //     sheet->MoveSurfaceTo(split_lo,0,0);
  //     sheet->MoveSurfaceTo(split_hi,1,0.004*t);
  // }
  // else if(timeStepCount<110 && timeStepCount>=90){
  //     sheet->MoveSurfaceTo(split_lo,0,0);
  //     sheet->MoveSurfaceTo(split_hi,1,-0.004*t);
  // }
  // else if(timeStepCount<140 && timeStepCount>=120){
  //     sheet->MoveSurfaceTo(split_lo,0,-0.002*t);
  //     sheet->MoveSurfaceTo(split_hi,1,0);
  // }
  //   else if(timeStepCount<170 && timeStepCount>=150){
  //     sheet->MoveSurfaceTo(split_lo,0,0.002*t);
  //     sheet->MoveSurfaceTo(split_hi,1,0);
  // }
  // else{
...
int main(int argc, char* argv[])
{
  ...
  sheet->updateSheetStatus(meshfile.data(),fix_file.data(),1);
